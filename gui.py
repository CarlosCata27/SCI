...
class FormFrame(ctk.CTkFrame):
    def __init__(self, master, **kwargs):
        ...
        global folio
        folio = tk.StringVar()
        labelFolio = ctk.CTkLabel(self, text="Folio:", font=NormalFont)
        labelFolio.grid(row=1, column=0, padx=20, pady=5, sticky=tk.E)
        inputFolio = ctk.CTkEntry(self, textvariable=folio, border_width=2, corner_radius=10)
        inputFolio.grid(row=1, column=1, padx=20, pady=5)
        ...
        labelEmpleado = ctk.CTkLabel(self, text="No. Empleado:", font=NormalFont)
...
class AppGui(ctk.CTk):
    def __init__(self, data_callback=None, *args, **kwargs):
        ...
        self.formFrame.grid(row=1, column=0, padx=20, pady=20, sticky="nsew")
